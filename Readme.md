...
|-----------------------|
| [EN](walkthrough/challenge-1/solution.md) |

---

## 📋 About the Workshop

This MicroHack scenario walks through the modernization from an application hosted on Azure Virtual Machines or Azure App Service to a completely managed container-based infrastructure. The workshop focuses on best practices, design principles, and real-world challenges for containerization scenarios, including hosting your own AI models.
...
✅ Containerize an existing .NET application using Docker  
✅ Deploy container images to Azure Container Registry  
✅ Create and configure Azure Container Apps  
✅ Implement CI/CD pipelines with GitHub Actions  
✅ Configure authentication, autoscaling, and monitoring  
✅ Host your own AI models using Ollama in containers  
✅ Expose AI endpoints via Azure API Management  
...
| Technology | Purpose |
|------------|---------|
| **Azure Container Apps** | Managed container hosting platform |
| **Azure Container Registry** | Private container image registry |
| **Azure App Service** | Initial PaaS hosting (migration source) |
...
```
AzureClub_MicroHack_Containers/
│
├── 📄 Readme.md                                 # This file
│
└── 📁 walkthrough/                              # Workshop challenges
    ├── 📁 challenge-1/                          # Challenge 1 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    ├── 📁 challenge-2/                          # Challenge 2 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    ├── 📁 challenge-3/                          # Challenge 3 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    ├── 📁 challenge-4/                          # Challenge 4 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    ├── 📁 challenge-5/                          # Challenge 5 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    ├── 📁 challenge-6/                          # Challenge 6 materials
    │   ├── solution.md                          # Solution guide
    │   └── img/                                 # Images
    └── 📁 challenge-7/                          # Challenge 7 materials
        ├── solution.md                          # Solution guide
        └── img/                                 # Images
```
...
- [**MicroHack Challenges**](#microhack-challenges)
  ...
  - [Challenge 7 - Testing the autoscaling of your app](#challenge-7---testing-the-autoscaling-of-your-app)
...
## Challenge 6 - Calling Ollama model with the API

### Goal

Your production-ready Container App is ready, but you cannot interact with Ollama model from other apps, not hosted on ACS. Time to expose the model endpoint with the Azure API Management and add some policies on top of it.

### Actions

* Create Azure API Management
* Expose the /chat API from Ollama with Azure API Managment
* Add the rate limit policy to enforce up to 5 calls from one IP address to exposed API

### Learning resources

* [Azure API Management - Quick Start](https://learn.microsoft.com/en-us/azure/api-management/get-started-create-service-instance)
* [Azure API Management Policies](https://learn.microsoft.com/en-us/azure/api-management/api-management-howto-policies)
* [Ollama API Reference](https://ollama.readthedocs.io/en/api/#endpoints)
* [Ollama API Reference - Samples](https://github.com/ollama/ollama/blob/main/docs/api.md#list-local-models)
...
* External apps and solutions can use /chat API with Ollama through API Management

## Challenge 7 - Testing the autoscaling of your app

### Goal

We have configured the containers to scale automatically under the load generated by the users. So let's check how this autoscaling works. We want to generate some simple traffic to the app to see how the app scales.

### Actions
* Make sure you can call the app without any authentication - it will simplify the flow
* Wrtie a simple BASH script using CURL to generate HTTP request to the app
* Check the Metrics witin the Container App to check how fast the app is scaling

### Learning resources

* [Azure Container Apps - Autoscaling](https://learn.microsoft.com/en-us/azure/container-apps/scale-app?pivots=azure-cli)
* [Azure Container Apps Metrics - Replica Count](https://learn.microsoft.com/en-us/azure/container-apps/metrics)
* Sample Script with CURL: 
```bash
  for i in {1..10}; do curl https://learn.microsoft.com/en-us/azure/container-apps/overview; done
```
...
* You are able to validate how Azure Container Apps can scale automatically using KEDA 
